...
with tab_monitor:
    ...
    if os.path.exists(LOG_PATH) and os.path.getsize(LOG_PATH) > 0:
        ...
        st.dataframe(logs.sort_values("timestamp", ascending=False).head(100), width='stretch', hide_index=True)
    else:
        ...
        if st.button("Run Monthly Ops", key="btn_an4"):
            ...
            if df.empty:
                ...
                if not mom.empty:
                    ...
                    st.altair_chart(mom_bar, width='stretch')
...
with tab_exec:
    ...
    if exec_ok:
        ...
        if not term_df.empty:
            ...
            st.altair_chart(heatmap + text_layer, width='stretch')
                ...
                try:
                    ...
                    if date_cols and num_cols:
                        ...
                        try:
                            ...
                            st.altair_chart(auto, width='stretch')
                        except Exception:
                            pass
                except Exception as exc:
    ...
    if st.button("Run Safety Query", key="btn_sf"):
        try:
            ...
            if not type_df.empty:
                ...
                st.altair_chart(bar_type, width='stretch')
            ...
            if not drv_df.empty:
                ...
                st.altair_chart(bar_drv, width='stretch')
