...
class PromptTranslatorOutput(BaseModel):
    baseline_prompt: str = Field(description="The cleaned musical instruction prefixed with 16-bit SNES chiptune.")
...
class PromptTranslator:
    ...
    def translate(self, raw_prompt: str) -> dict:
        try:
            ...
            return {
                "baseline_prompt": f"16-bit SNES chiptune {raw_prompt}",
                "improved_parameters": {"BPM": "120", "Key": "C Major", "Lead": "Square wave"}
            }
